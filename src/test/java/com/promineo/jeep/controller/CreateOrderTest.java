 ...
 */
	@Test
	void testCreateOrderReturnsSucces201() {
		...
		System.out.println(order.getModel().getModelId());
		System.out.println(order.getModel().getTrimLevel());
		System.out.println(order.getModel().getNumDoors());
		System.out.println(order.getColor().getColorId());
		System.out.println(order.getEngine().getEngineId());
		System.out.println(order.getTire().getTireId());
